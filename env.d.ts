/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: cfe5d18462e06893803b6b7282bd93bf)
// Runtime types generated with workerd@1.20250816.0 2025-04-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		API_HOST: "http://127.0.0.1:3000" | "staging.example.com" | "production.example.com";
		CF_CLIENT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_HOST" | "CF_CLIENT_ID" | "CF_CLIENT_SECRET" | "STRAPI_URL" | "STRAPI_TOKEN" | "NEXTJS_ENV">> {}
}
